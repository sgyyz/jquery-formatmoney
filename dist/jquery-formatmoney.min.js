 ...
 */
!function($){"use strict";$.broswer||($.broswer={},$.broswer.mozilla=/mozilla/.test(navigator.userAgent.toLowerCase())&&!/webkit/.test(navigator.userAgent.toLowerCase()),$.broswer.webkit=/webkit/.test(navigator.userAgent.toLowerCase()),$.broswer.opera=/opera/.test(navigator.userAgent.toLowerCase()),$.broswer.msie=/msie/.test(navigator.userAgent.toLowerCase()));var a={init:function(a){return a=$.extend({prefix:"",thousands:",",decimal:".",precision:2,allowZero:!1,allowNegative:!1},a),this.each(function(){function b(b){var d,e,g,h=b.replace(a.prefix,""),i=b.replace(/\D/g,""),j=h.indexOf(a.decimal);return a.allowNegative&&(f=/-/.test(b)),f&&(j-=1),j>-1?(d=i.slice(0,j),""===d?(d="0",e=i):e=i.slice(j,i.length)):(d=i,e=""),d=d.replace(/\B(?=(\d{3})+(?!\d))/g,a.thousands),g=(f?"-":"")+d+a.decimal,a.precision>0&&(e=e.slice(0,a.precision),e.length<a.precision&&(e+=new Array(a.precision-e.length+1).join(0)),g+=e),c(g)}function c(b){return a.prefix+b}var d=$(this),e=d.is('input[type="text"]'),f=!1;e||d.text(b(d.text()))})}};$.fn.formatmoney=function(b){return a.init.call(this,b)}}(window.jQuery||window.Zepto);